...
def seed():
    ...
    try:
        ...
        devices = [
            ...
            (3, 1, "SO2 Analyzer", "ANALYZER", "tcp_custom", "172.21.36.206", 8003, "02 41 46 32 32 31 36 30 30 03", "etx", 60, 5, 1, "offline"),
            (4, 1, "NOx Analyzer", "ANALYZER", "tcp_custom", "172.21.36.205", 8002, "02 41 43 33 32 31 36 30 34 03", "etx", 60, 5, 1, "offline")
        ]
