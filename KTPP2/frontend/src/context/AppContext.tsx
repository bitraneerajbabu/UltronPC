...
export const AppProvider = ({ children }) => {
  ...
  const [plantName, setPlantName] = useState(localSettings.plantName || 'KAKATIYA THERMAL POWER PROJECT (KTPP) - Unit 2');
  const [plantAddress, setPlantAddress] = useState(localSettings.plantAddress || 'Bhupalapally, Telangana');
