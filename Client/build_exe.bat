...
echo [OK] Frontend built and copied to ultron_backend/ui_dist/
...
pip install pyinstaller pywebview --upgrade
...
pyinstaller ..\installer.py --onefile --console --icon=ultron.ico --name=UltrON_Installer --noconfirm
if errorlevel 1 goto installer_failed

echo.
echo ============================================================
echo   [SUCCESS] UltrON Standalone App and Installer Built Successfully!
echo   Application Location: ultron_backend\dist\UltrON.exe
echo   Installer Location:   ultron_backend\dist\UltrON_Installer.exe
echo ============================================================
echo.
goto end
